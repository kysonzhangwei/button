...
var _Button = function (_Component) {
  _inherits(_Button, _Component);
  ...
  _createClass(_Button, [{
    ...
    value: function render() {
      ...
      // const _style = this.getStyle(type, containerStyle);
      ...
      return _react2.default.createElement(_reactNative2.Button, {
        ...
        style: [type === "default" && {
          backgroundColor: this.state.disabled ? "#f5f5f5" : "#fff"
        }, {
          alignItems: "center",
          height: 40,
          borderColor: "#dddddd",
        ...
        }, this.state.visable ? containerStyle : [containerStyle, _extends({}, _visable.visStyle)]],
        onClick: this.clickFn,
        loading: loading
      }, icon ? _react2.default.createElement(_reactNative.Text, null, _react2.default.createElement(_icon2.default, { type: icon, color: [type === "default" && { color: '#fff' }, this.state.textStyle.color] }), "  ") : null, _react2.default.createElement(_reactNative.Text, {
        ref: function ref(t) {
          return _this2.BtnText = t;
        },
        style: [this.state.disabled && (type === "ghost" || type === "default") && {
          color: "rgba(0,0,0,.1)"
        }, type === "default" && {
          color: this.state.disabled ? "#e0e0e0" : "#000"
...
_Button.propTypes = {
  ...
  /* 按钮是否可见 | {true, false} */
  visable: _propTypes2.default.bool,
  /* 组件样式（不包含文字） |  */
...
// export default InitComponent(_Button);